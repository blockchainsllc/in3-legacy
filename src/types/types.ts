...
export const validateIN3RPCRequestConfig: any = ajv.compile(validationDef.IN3RPCRequestConfig)
...
export const validateRPCResponse: any = ajv.compile(validationDef.RPCResponse)
...
export const validateIN3ResponseConfig: any = ajv.compile(validationDef.IN3ResponseConfig)
...
export const validateIN3NodeConfig: any = ajv.compile(validationDef.IN3NodeConfig)
...
export const validateProof: any = ajv.compile(validationDef.Proof)
...
export const validateLogProof: any = ajv.compile(validationDef.LogProof)
...
export const validateAccountProof: any = ajv.compile(validationDef.AccountProof)
...
export const validateSignature: any = ajv.compile(validationDef.Signature)
...
export const validateChainSpec: any = ajv.compile(validationDef.ChainSpec)
...
export const validateIN3Config: any = ajv.compile(validationDef.IN3Config)
...
export const validateIN3NodeWeight: any = ajv.compile(validationDef.IN3NodeWeight)
...
export const validateServerList: any = ajv.compile(validationDef.ServerList)
...
export const validateAuraValidatoryProof: any = ajv.compile(validationDef.AuraValidatoryProof)
...
export const validateIN3RPCConfig: any = ajv.compile(validationDef.IN3RPCConfig)
...
export const validateIN3RPCHandlerConfig: any = ajv.compile(validationDef.IN3RPCHandlerConfig)
