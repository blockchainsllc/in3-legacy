...
/** validates the ValidatorProof and returns true | false. if it failes, use validateValidatorProof.errors to get a list of errors. */
export const validateValidatorProof = ajv.compile(validationDef.ValidatorProof)
export const ValidatorProofDefinition = validationDef.ValidatorProof
/** validates the ValidatorProof and throws in case of an a invalid object.*/
export function validateValidatorProofAndThrow (data:ValidatorProof) { validateAndThrow(validateValidatorProof,data) }
