...
export interface Proof {
     ...
     */
    type: 'transactionProof' | 'receiptProof' | 'blockProof' | 'accountProof' | 'callProof' | 'logProof' | 'auraValidatoryProof'
    /**
    ...
    logProof?: LogProof
    /**
     * the Validator Proof specific for aura
     */
