...
export interface ChainSpec {
    ...
    engine?: string
    /**
     * An object containing the validator info at different blocks, keyed by blocknumber as a number string
     */
    validatorInfo?: {
        [name: string]: {
            /**
